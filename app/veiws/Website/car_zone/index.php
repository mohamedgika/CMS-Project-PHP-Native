...
<html lang="en-us">
  <head>
    ...
    <link rel="stylesheet" href="<?=URL;?>Website/car_zone/assets/css/bootstrap.min.css">
    <!-- FancyBox -->
	<link href="<?=URL;?>car_zone/assets/css/fancybox/jquery.fancybox.css" rel="stylesheet">
    <link rel="stylesheet" href="<?=URL;?>Website/car_zone/assets/css/style.css"> 
    <link rel="stylesheet" href="<?=URL;?>Website/car_zone/assets/css/animate.min.css">
    <link rel="stylesheet" href="<?=URL;?>Website/car_zone/assets/css/font-awesome.min.css">
    <!--[if lt IE 9]>
  ...
  <body> 
      ...
      <nav class="navbar navbar-default navbar-static" role="navigation">
        <div class="container">
          <div class="navbar-header">
            ...
            <a class="navbar-brand nav-external" href="#home"><strong>CARS</strong></a>
          </div>
      ...
      <div class="container">
        <div class="content cover text-center">
         <!-- <div class="row">
			...
			<div class="heroText">
                <h2><span> Car Shop </span><br>
                  <strong>Come With Us In Round To Show Cars</strong></h2>
              </div>
			</div>
        </div>
      </div>
         ...
         <div class="row services-list">
					<div class="col-sm-6 col-md-3 text-center service animated fadeInUp visible" data-animation="fadeInUp">
						<div class="service-icon"> 
                            <img src="<?=URL;?>Website/car_zone/assets/img/car-wash.jpg" alt=""/> 
						</div>
					...
					<div class="col-sm-6 col-md-3 text-center service animated fadeInUp visible" data-animation="fadeInUp" data-animation-delay="200">
						<div class="service-icon">
							<img src="<?=URL;?>Website/car_zone/assets/img/car-service.jpg" alt=""/> 
						</div>
					...
					<div class="col-sm-6 col-md-3 text-center service animated fadeInUp visible" data-animation="fadeInUp" data-animation-delay="400">
						<div class="service-icon">
							<img src="<?=URL;?>Website/car_zone/assets/img/Car-painting.jpg" alt=""/> 
						</div>
					...
					<div class="col-sm-6 col-md-3 text-center service animated fadeInUp visible" data-animation="fadeInUp" data-animation-delay="600">
						<div class="service-icon">
							<img src="<?=URL;?>Website/car_zone/assets/img/car-modi.jpg" alt=""/> 
						</div>
              ...
              <div id="portfolio">
                ...
                <ul class="items list-unstyled clearfix animated hiding" data-animation="fadeInRight">
                  <li class="item branding">
                     <a href="<?=URL;?>Website/car_zone/assets/img/work/1.jpg" class="fancybox">
                      <img src="<?=URL;?>Website/car_zone/assets/img/work/1.jpg" alt="">
                      <div class="overlay">
                  ...
                  <li class="item photography">
                     <a href="<?=URL;?>Website/car_zone/assets/img/work/2.jpg" class="fancybox">
                      <img src="<?=URL;?>Website/car_zone/assets/img/work/2.jpg" alt="">
                      <div class="overlay">
                  ...
                  <li class="item branding">
                     <a href="<?=URL;?>Website/car_zone/assets/img/work/3.jpg" class="fancybox">
                      <img src="<?=URL;?>Website/car_zone/assets/img/work/3.jpg" alt="">
                      <div class="overlay">
                  ...
                  <li class="item photography">
                     <a href="<?=URL;?>Website/car_zone/assets/img/work/4.jpg" class="fancybox">
                      <img src="<?=URL;?>Website/car_zone/assets/img/work/4.jpg" alt="">
                      <div class="overlay">
                  ...
                  <li class="item photography">
                     <a href="<?=URL;?>Website/car_zone/assets/img/work/5.jpg" class="fancybox">
                      <img src="<?=URL;?>Website/car_zone/assets/img/work/5.jpg" alt="">
                      <div class="overlay">
                  ...
                  <li class="item web">
                     <a href="<?=URL;?>Website/car_zone/assets/img/work/6.jpg" class="fancybox">
                      <img src="<?=URL;?>Website/car_zone/assets/img/work/6.jpg" alt="">
                      <div class="overlay">
                  ...
                  <li class="item photography">
                     <a href="<?=URL;?>Website/car_zone/assets/img/work/7.jpg" class="fancybox">
                      <img src="<?=URL;?>Website/car_zone/assets/img/work/7.jpg" alt="">
                      <div class="overlay">
                  ...
                  <li class="item web">
                    <a href="<?=URL;?>Website/car_zone/assets/img/work/8.jpg" class="fancybox">
                      <img src="<?=URL;?>Website/car_zone/assets/img/work/8.jpg" alt="">
                      <div class="overlay">
          ...
          <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12 teammate" data-animation="fadeInLeft" data-delay="600">
              <div class="profile-photo">
                <img class="img-responsive" src="<?=URL;?>Website/car_zone/assets/img/team/1.jpg" alt="">
              </div>
              <div class="bio">
                <h4>John Doe</h4>
                <h5>Web Developer</h5>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 teammate animated hiding" data-animation="fadeInUp" data-delay="300">
              <div class="profile-photo">
                <img class="img-responsive" src="<?=URL;?>Website/car_zone/assets/img/team/2.jpg" alt="">
              </div>
              <div class="bio">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 teammate animated hiding" data-animation="fadeInUp" data-delay="300">
              <div class="profile-photo">
                <img class="img-responsive" src="<?=URL;?>Website/car_zone/assets/img/team/3.jpg" alt="">
              </div>
              <div class="bio">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 teammate animated hiding" data-animation="fadeInRight" data-delay="600">
              <div class="profile-photo">
                <img class="img-responsive" src="<?=URL;?>Website/car_zone/assets/img/team/4.jpg" alt="">
              </div>
              <div class="bio">
      ...
      <div class="container"> 
        <div class="row">
          <div class="col-lg-12 animated hiding" data-animation="fadeInUp">
            ...
            <p class="copyright"> 
              Template by <a href="http://www.webthemez.com">WebThemez</a> &middot; 
    ...
    <script src="<?=URL;?>Website/car_zone/assets/js/modernizr-latest.js"></script>
    <script src="<?=URL;?>Website/car_zone/assets/js/jquery.min.js"></script>
    <script src="<?=URL;?>Website/car_zone/assets/js/bootstrap.min.js"></script>
	<script src="<?=URL;?>Website/car_zone/assets/js/jquery.cslider.js"></script>
    <script src="<?=URL;?>Website/car_zone/assets/js/isotope.pkgd.min.js"></script>
	<script src="<?=URL;?>Website/car_zone/assets/js/jquery.fancybox.pack.js"></script>  
	<script src="<?=URL;?>Website/car_zone/assets/js/jquery.fancybox-media.js"></script>  
    <script src="<?=URL;?>Website/car_zone/assets/js/imagesloaded.min.js"></script>
    <script src="<?=URL;?>Website/car_zone/assets/js/jquery.scrollTo.min.js"></script>
    <script src="<?=URL;?>Website/car_zone/assets/js/jquery.nav.min.js"></script>
    <script src="<?=URL;?>Website/car_zone/assets/js/jquery.appear.min.js"></script>
    <script src="<?=URL;?>Website/car_zone/assets/js/twitterFetcher.min.js"></script>
    <script src="<?=URL;?>Website/car_zone/assets/js/script.js"></script> 
